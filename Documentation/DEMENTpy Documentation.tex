...
Please be aware that this method of reinitialization is different from R-based DEMENT, which instead uses biomass-based frequency calculation. The reason to do so is illustrated by the comparisons below:
